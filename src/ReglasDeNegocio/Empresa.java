...
public class Empresa {
  ...
  private double  precio;
    ...
    public Empresa(int idempresa, Ciudad ciudad, String nombreempresa, String direccion1, String direccion2, String estado, String sitioweb, String email, String telefono, int stock, double precio) {
...
@Override
     ...
     public static boolean empresa_editar(Empresa empresa) throws Exception
  {
      ...
      public static boolean empresa_eliminar(Empresa empresa) throws Exception
  {
      boolean respuesta=false;
      Conexion con = new Conexion(Global.driver, Global.url, Global.user, Global.pass);
      try {
          ...
          ArrayList<Parametro> parametros = new ArrayList<Parametro>();
          //llenamos el arraylist con todos los parametros
          parametros.add(new Parametro(1, empresa.idempresa));
          //llenar el comando con los parametros
          cmd.setLstParametros(parametros);
          comandos.add(cmd);
          //llamamos al funcion que ejecuta la transaccion en la base de datos
