...
public class FrmEmpresa extends javax.swing.JFrame {
  ...
  private void limpiarControles() {
    ...
    private void initComponents() {
        ...
        lblCodigofacultad.setText("Ciudad:");
...
Menu obj=new Menu();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            //Ciudad ciudades = ciudad.ciudad_buscarporidCategoria(Integer.ToInt32(jComboBox())));
            //empresa.setCiudad(ciudades);  
               // jComboBoxCiudad.setText(Integer.toString(()));
        ...
        if (btnNuevo.getText().compareTo("Nuevo")==0) {
            ...
            if(btnNuevo.getText().compareTo("Registrar")==0){
                try {
                   ...
                   // empresa.setCiudad(jComboBoxCiudad.getText);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try {
                if (empresa.empresa_eliminar(empresa) ) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try {
                    empresa.setIdempresa(Integer.parseInt(txtCodigo.getText()));
                    //empresa.setIdciudad(Integer.parseInt(jComboBoxCiudad()));
                    empresa.setNombreempresa(txtNombre.getText());
                    empresa.setDireccion1(txtDireccion1.getText());
                    empresa.setDireccion2(txtDireccion2.getText());
                    empresa.setEstado(txtEstado.getText());
...
DefaultTableModel modelo = (DefaultTableModel) TablaListarempresa.getModel();
        ...
        for(Empresa p : lista){
            modelo.addRow(new Object[]{ p.getIdempresa(),p.getNombreempresa(),p.getDireccion1(),p.getDireccion2(),p.getEstado(),p.getSitioweb(),p.getEmail(),p.getTelefono()});
        }}
